...
( function($, document, window) {
  ...
  publicMethod.init = function() {
    ...
    $div().append($div("TopLeft"), $topBorder = $div("TopCenter"), $div("TopRight")), $div(false, 'clear:left').append( $leftBorder = $div("MiddleLeft"), $content, $rightBorder = $div("MiddleRight")), $div(false, 'clear:left').append($div("BottomLeft"), $bottomBorder = $div("BottomCenter"), $div("BottomRight"))).children().children().css({
      'float' : 'left'
    });
      ...
      complete : function() {
        ...
        if(loadedCallback) {
          if( typeof loadedCallback === 'function') {
            ...
            erly.trackException(new Error('Non-function for loadedCallback in colorbox. ' + typeof loadedCallback));
          }
        }
